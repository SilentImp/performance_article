...
Чудесно, у нас есть отчет. Но что с ним сделать? Можно проанализировать какие-то из метрик и завершить работу скрипта с ненулевым кодом, что остановит пайплайн: 
